...
import com.hitrosttech.notetaker.feature_note.presentation.notes.components.NotesItem
import com.hitrosttech.notetaker.feature_note.presentation.notes.components.OrderSection
		...
		Column(
			...
			Row(
				...
				IconButton(onClick = { viewModel.onEvent(NotesEvent.ToggleOrderSection) }) {
					Icon(imageVector = Icons.Default.Sort, contentDescription = "Sort button")
				}
			}
